...
import {
    ArrowDown, ArrowUp, DollarSign, PiggyBank, TrendingUp,
    Utensils, Home, Car, ShoppingCart, Gift, Zap, Activity, CreditCard,
    Clock,
    RefreshCcw,
    Info,
    ChevronDown,
...
const Layout = ({ onLogout, user }) => {
    ...
    // to fetch the transaction fro the server
                    ...
                    <div className={styles.grid.rightColumn}>
                        <div className={styles.cards.base}>
                            ...
                            <div className={styles.transactions.dataStackingInfo}>
                                ...
                                <span>
                                    Transactions are stacked by date(newest as first)
