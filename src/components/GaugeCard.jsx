...
const GaugeCard = ({
    ...
    // For negative values, show the absolute value in the chart 
    ...
    return (
        <div className="bg-white rounded-xl p-5 -mx-3 md:-mx-5 shadow-sm flex flex-col items-center border border-gray-100">
